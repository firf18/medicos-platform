...
/**
 * Script para registrar un paciente de prueba en Supabase
 * Este script crea un usuario paciente con datos completos para probar el dashboard
 */
...
async function createTestPatient(): Promise<void> {
  try {
    console.log('🚀 Iniciando registro de paciente de prueba...');
